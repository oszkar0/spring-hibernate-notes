...
import com.oskar.cruddemo.entity.*;
...
public class CruddemoApplication {
	...
	private void createCourseAndReviews(AppDAO appDAO){
		//create course
		Course tempCourse = new Course("How to play football");
	...
	private void createCourseAndStudents(AppDAO appDAO){
		Course course = new Course("How to play volleyball");

		Student student1 = new Student("Robert", "Robert", "robrob@gmail.com");
		Student student2 = new Student("Kacper", "Kacper", "kackac@wp.pl");

		course.addStudent(student1);
		course.addStudent(student2);

		//students save will be cascaded
		appDAO.save(course);
	}
